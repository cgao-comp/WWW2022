...
public class MyExecute {
	...
	//部署的sensor比例:
	public static int min_obv_num=35000;
	public static int max_obv_num=140001;
	public static int add_obv_num=175000;
	...
	public static double max_infected_p=0.11;
	public static double add_infected_p=0.2;
	...
	public static void initNet_heterogeneous_combinedFONC_divideWeight(int type) throws Exception {
		...
		String path="/Users/houdongpeng/1/ComplexNetwork/src/quick_J_0117/results.txt";
		...
		for(double infected_p=min_infected_p;infected_p<=max_infected_p;infected_p=infected_p+add_infected_p) {
			...
			//double setRate = 0;
			for (allObvNum = min_obv_num; allObvNum <= max_obv_num; allObvNum += add_obv_num) {
					System.out.println("总观察点: " + allObvNum + " 选择数量: " + setNum);
					double f_score=0;
					total_time=0;
					GFNL_time1=0;
					time_myStartEXE4=0;					
...
//ELSE:
						mySi.initNet_SIR_Greedy_fromFile(network, infected_p, 0, center_Num, 
								"/Users/houdongpeng/1/ComplexNetwork/src/quick_J_0117/obv_info.txt");
...
//						System.out.println("距离矩阵生成完成......");
						ALG.shortPath_fourworkingsensor=mySi.readInf_4_from_oneFile(network,obv_set,
								"/Users/houdongpeng/1/ComplexNetwork/src/quick_J_0117/github_shortestPath.txt");
						...
						HashSet<String> myFinalSet = mySi.getJordonCenter_dividedWeight(network, obv_set, num_need_JordanCenter, type);
